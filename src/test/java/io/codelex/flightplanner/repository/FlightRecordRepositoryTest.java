...
class FlightRecordRepositoryTest {
    ...
    void search_should_not_return_any_results_when_nothing_matched() {
        ...
        FlightRecord flight = getFlightRecord(RIX, DXB);
    ...
    void search_from_should_find_flight_by_country() {
        ...
        //when
        List<FlightRecord> flights = repository.searchFlightsFrom("Latvia");
    ...
    void search_to_should_find_flight_by_country() {
        ...
        //when
        List<FlightRecord> flights = repository.searchFlightsTo("UnitedArabEmirates");
    ...
    @NotNull
    private FlightRecord getFlightRecord(AirportRecord RIX, AirportRecord DXB) {
